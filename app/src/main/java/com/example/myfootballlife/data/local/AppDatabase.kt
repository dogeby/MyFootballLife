...
@Database(entities = [Tweets::class, Users::class, Channels::class, Videos::class, Subscription::class, Team::class], version = 1, exportSchema = false)
@TypeConverters(StringMapConverter::class, StringListConverter::class, ThumbnailsMapConverter::class, KindConverter::class)
